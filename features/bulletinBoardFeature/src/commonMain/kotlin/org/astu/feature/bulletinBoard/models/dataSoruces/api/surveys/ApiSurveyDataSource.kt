package org.astu.feature.bulletinBoard.models.dataSoruces.api.surveys
...
import org.astu.feature.bulletinBoard.models.dataSoruces.api.surveys.SurveyMappers.toDto
...
class ApiSurveyDataSource : SurveyDataSource {
    ...
    override suspend fun create(survey: CreateSurvey): ContentWithError<Uuid, CreateSurveyErrors> {
        ...
        return ContentWithError(uuidFrom(id), error = null)
    }

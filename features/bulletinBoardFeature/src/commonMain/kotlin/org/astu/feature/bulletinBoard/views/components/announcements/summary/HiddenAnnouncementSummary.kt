...
fun HiddenAnnouncementSummary(
    ...
    val hidingMomentMomentText = remember { "Скрыто ${humanizeDateTime(content.hidingTime)}" }
    AnnouncementSummary(content, hidingMomentMomentText, announcementDropDown, modifier)
}
...
@Composable
fun DelayedPublishedAnnouncementSummary(
    ...
    val delayedPublishedMomentText = remember { "Будет опубликовано ${humanizeDateTime(content.delayedPublicationTime)}" }
    AnnouncementSummary(content, delayedPublishedMomentText, announcementDropDown, modifier)
}
...
class UserListOfRequestSingleWindowScreen(
    val vm: UserRequestViewModel,
    onReturn: (() -> Unit)?,
    onChange: (ServiceScreen) -> Unit
) : ServiceScreen("Список ваших заявлений", onReturn, onChange) {
    @Composable
    ...
    @Composable
    fun ListItem(modifier: Modifier, createdRequest: CreatedRequest) {
        Card(
